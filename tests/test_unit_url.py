...
def test_url():
    assert (
        str(URL(account="testaccount", user="admin", password="test", warehouse="testwh"))
        == "snowflake://admin:test@testaccount/?warehouse=testwh"
    )

    assert (
        str(URL(account="testaccount", user="admin", password="test"))
    ...
    assert (
        str(URL(account="testaccount", user="admin", password="test", database="testdb"))
